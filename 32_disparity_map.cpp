...
const String keys =
    ...
    "{@left          |ambush_5_left.jpg | left view of the stereopair                                       }"
    "{@right         |ambush_5_right.jpg | right view of the stereopair                                      }"
...
int main(int argc, char** argv)
{
    ...
    String left_im = parser.get<String>("ambush_5_left");
    String right_im = parser.get<String>("ambush_5_right");
