...
int Drawing_Random_Lines( Mat image, char* window_name, RNG rng )
{
  ...
  for( int i = 0; i < NUMBER; i++ )
  {
	...
	//line( image, pt1, pt2, Scalar(0,0,0), 10, 8);
...
int Displaying_Random_Text( Mat image, char* window_name, RNG rng )
{
  ...
  for ( int i = 1; i < NUMBER; i++ )
  {
    ...
    putText( image, "FUCK", org, rng.uniform(0,8),
...
{
  Size textsize = getTextSize("ROBOCON forever!", FONT_HERSHEY_COMPLEX, 3, 5, 0);
  ...
  for( int i = 0; i < 255; i += 2 )
  {
    ...
    putText( image2, "ROBOCON forever!", org, FONT_HERSHEY_COMPLEX, 3,
